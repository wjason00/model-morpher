...
# Quality Ver
RESOLUTION = 128 # Resolution increases cost cubically (meshgrid)
FRAME_COUNT = 30
...
TAUBIN_ITERATIONS = 15  # Number of Taubin smoothing passes (more = smoother)
...
SDF_QUERY_BATCH_SIZE = 200000  # Number of points to query SDF network in one batch
FRAME_BATCH_SIZE = 5  # Number of frames to process in parallel during morphing